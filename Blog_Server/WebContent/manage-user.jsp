...
<%
//判断有没有用户列表数据，如果没有则跳转到user.s？op=query 控制层：query 应用层：findAll
//servlet也是页面，请求（登录用户的数据）、会话 request ：跨页面、跨请求
...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <h1 class="page-header">操作</h1>
        ...
        <form action="user.s">
       		 用户名：<input type="text" name="account" value="${params.account}">
  	 		  姓名：<input type="text" name="name" value="${params.name}">
 	  		  电话：<input type="text" name="tel" value="${params.tel}">
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">注册日期</span></th>
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              ...
              <tr>
                <td wdith="20%">用户名:</td>
                <td width="80%"><input type="text" value="" class="form-control" id="username" name="account" maxlength="10" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">电话:</td>
                <td width="80%"><input type="text" value="" class="form-control" id="usertel" name="tel" maxlength="13" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">旧密码:</td>
